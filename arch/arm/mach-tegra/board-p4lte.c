...
static struct tegra_uhsic_config hsic_phy_config = {
	.enable_gpio = GPIO_AP2LTE_WAKEUP,
	.reset_gpio = -1,
	.sync_start_delay = 9,
	.idle_wait_delay = 17,
	.term_range_adj = 0,
...
static int __init bcm4330_bt_clk_init(void)
{
	struct clk *bt_32clk = clk_get_sys(NULL, "blink");
	if (!IS_ERR(bt_32clk)) {
		clk_set_rate(bt_32clk, bt_32clk->parent->rate);
		clk_enable(bt_32clk);
	}
	return 0;
}
...
static void p4_lte_modem_bootloader_init()
{
...
#ifdef CONFIG_MACH_SAMSUNG_P4LTEUSCC
	.temp_high_threshold = 56000,
	/* 546 + 32 (dT) ->600 by kim2054's request*/
	.temp_high_recovery = 44000,	/* 426 */
	.temp_low_recovery = 1000,		/* -10 */
	.temp_low_threshold = -3000,		/* -40 */
	.temp_high_threshold_lpm = 56000,	/* 50c */
	.temp_high_recovery_lpm = 44000,	/* 45c */
	.temp_low_recovery_lpm = 1000,		/* 2c */
	.temp_low_threshold_lpm = -3000,		/* 0c */
#else
