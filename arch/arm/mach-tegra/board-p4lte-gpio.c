...
/* dedicated to P4 Main Rev06 */
    {GPIO,	GPIO_USB_SEL2,			GPIO_OUTPUT,	GPIO_LEVEL_NONE }, /* 1 */
    ...
    {GPIO,	GPIO_THERMAL_I2C_SCL,		GPIO_OUTPUT,	GPIO_LEVEL_NONE }, /*10*/
    ...
    {GPIO,	GPIO_IMA_SLEEP,			GPIO_OUTPUT,	GPIO_LEVEL_NONE }, /*20*/
    ...
    {GPIO,	GPIO_BT_EN,			GPIO_OUTPUT,	GPIO_LEVEL_NONE }, /*30*/
    ...
    {GPIO,	GPIO_BT_WAKE,			GPIO_OUTPUT,	GPIO_LEVEL_NONE }, /*40*/
    ...
    {GPIO,	GPIO_TA_nCHG,			GPIO_INPUT,	GPIO_LEVEL_NONE }, /*50*/
    ...
    {GPIO,	GPIO_ADC_I2C_SCL_REV05,			GPIO_INPUT,	GPIO_LEVEL_LOW }, /*60*/
    ...
    {GPIO,	GPIO_EAR_MICBIAS_EN,		GPIO_OUTPUT,	GPIO_LEVEL_NONE }, /*90*/
    ...
    {GPIO,	GPIO_CAM_FLASH_EN,    GPIO_OUTPUT,	GPIO_LEVEL_LOW  }, /*95*/
