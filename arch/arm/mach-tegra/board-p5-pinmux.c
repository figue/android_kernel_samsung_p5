...
static __initdata struct tegra_pingroup_config p3_pinmux_rev07[] = {
	{TEGRA_PINGROUP_ATA,	TEGRA_MUX_GMI,			TEGRA_PUPD_PULL_DOWN,	TEGRA_TRI_NORMAL},	/* MLCD_ON(GPIO_PI4) -> NC */
};
...
static __initdata struct tegra_pingroup_config p3_pinmux[] = {
	...
	{TEGRA_PINGROUP_SLXA,	TEGRA_MUX_PCIE,			TEGRA_PUPD_PULL_DOWN,	TEGRA_TRI_NORMAL},
	{TEGRA_PINGROUP_SLXC,	TEGRA_MUX_SPI4,			TEGRA_PUPD_PULL_DOWN,	TEGRA_TRI_NORMAL},
	{TEGRA_PINGROUP_SLXD,	TEGRA_MUX_SPI4,			TEGRA_PUPD_PULL_DOWN,	TEGRA_TRI_NORMAL},
...
#if defined(CONFIG_MACH_SAMSUNG_P5WIFI)
	{TEGRA_PINGROUP_SPIG,	TEGRA_MUX_SPI2_ALT, 	TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
#else
...
int __init p3_pinmux_init(void)
{
	...
	if (system_rev > 6) {
		tegra_pinmux_config_table(p3_pinmux_rev07, ARRAY_SIZE(p3_pinmux_rev07));	
	}
