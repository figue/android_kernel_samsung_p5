/*
 * wm8994_p4.c  --  WM8994 ALSA Soc Audio driver related Aries
 *
...
struct gain_info_t voicecall_gain_table[VOICECALL_GAIN_NUM] = {
	{ /* COMMON */
		...
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTR_BOOST_MASK,
		.gain = 0x7 << WM8994_SPKOUTR_BOOST_SHIFT /* +12dB */
...
#endif
#else
		/* adjust Loopback Ear-Mic Gain for AC level in factory test */
		wm8994_write(codec, WM8994_RIGHT_LINE_INPUT_1_2_VOLUME,
			WM8994_IN1R_VU | 0x0E);
#endif
...
void wm8994_record_bluetooth(struct snd_soc_codec *codec)
{
	...
	if (wm8994->voip_call_active) {
		if (wm8994->voip_bt_nrec_state == VOIP_BT_NREC_OFF) {
			...
			wm8994_write(codec, 0x580, 0x3253);
			wm8994_write(codec, 0x581, 0x7C00);
		}
